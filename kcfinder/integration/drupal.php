    ...
    if (!isset($authenticated)) {
        ...
        if (!isset($bootstrap_file_found) || $bootstrap_file_found) {
            ...
            if (user_access('access kcfinder')) {
                ...
                global $user;
                $_SESSION['KCFINDER']['uploadURL'] = strtr(variable_get('kcfinder_upload_url',
                        'sites/default/files/kcfinder'), array ('%u' => $user->uid, '%n' => $user->name));
                $_SESSION['KCFINDER']['uploadDir'] = strtr(variable_get('kcfinder_upload_dir', ''),
                    array ('%u' => $user->uid, '%n' => $user->name));
