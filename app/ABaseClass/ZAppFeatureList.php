...
class ZAppFeatureList extends ZAppFeature{

    public function overwriteModal(){
        global $modalReg;
        $modalReg->addAboveBGBlur(array("ZAppFeatureList","addForm")); //harus dioverwrite
    }
...
//                $('#<?//=$this->feat_id;?>//_name').val('Name');
                $('#<?=$this->feat_id;?>_des').html('Description');
    ...
    public function addForm(){
        ...
        <div class="list_item_form" id="<?=$this->feat_id;?>_kosong" style="display: none; padding: 10px; padding-top: 0px;">
            ...
            <div style="width: 600px;" >
                <h1 style="text-align: center; font-size: 17px;">New <?=$this->feat_name;?></h1>
                <hr>
                <div class="col-md-7">
                    ...
                    <div class="form-group">
                        <label for="<?=$this->feat_id;?>_name"><?=$this->feat_name;?> Title</label>
                        <?
                        TextLimiter::inputText("text",$this->feat_id."_name",$this->feat_id."_name",$this->feat_name." Name",$deal_name,25,1);
                        ?>
                    </div>
...
//                    design += '</div>';
                    ...
                    list += '<div class="col-md-7 arraylist_name">'+attr['<?=$this->feat_id;?>_name']+'</div>';
    ...
    function appListViewer(){
        ...
        <? foreach($arrDeals as $num=>$deal){?>
            <div class="<?=$this->feat_id;?>_item" id="<?=$this->feat_id;?>_<?=$num;?>">
                ...
                <div class="<?=$this->feat_id;?>_item_description" ><?=$deal[$this->feat_id.'_des'];?></div>
            </div>
        <?} ?>
