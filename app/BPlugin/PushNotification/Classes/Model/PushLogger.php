...
class PushLogger extends Model{

    public $table_name = "push__pushnot_logger";
    ...
    static function savelog($camp_id,$device_id,$acc_id,$status,$log_text,$log_multicast_id,$log_app_id,$client_camp_id){
