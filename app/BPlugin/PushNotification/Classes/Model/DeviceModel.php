...
class DeviceModel extends Model{
    ...
    public $table_name = "push__device";
    ...
    public $dev_lat;
    public $dev_not_send;
    public $crud_webservice_allowed = 'did,device_id,dev_app_id,device_type,acc_id,logindate,firstlogin,dev_lng,dev_lat,dev_not_send';
