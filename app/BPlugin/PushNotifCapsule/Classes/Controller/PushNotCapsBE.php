...
class PushNotCapsBE extends WebService{

    var $access_PushNotCampCaps = "admin";
    function PushNotCampCaps(){

        $cal = new PushNotCampCaps();
//        $cal->printColumlistAsAttributes();
    ...
    var $access_GCMResultCaps = "admin";
    function GCMResultCaps(){

        $cal = new GCMResultCaps();
//        $cal->printColumlistAsAttributes();
        //send the webclass
        $webClass = __CLASS__;
    ...
    var $access_PushLoggerCaps = "admin";
    function PushLoggerCaps(){

        $cal = new PushLoggerCaps();
//        $cal->printColumlistAsAttributes();
        //send the webclass
        $webClass = __CLASS__;
