 ...
 */
class VRCustomer extends WebService{
 ...
 $customer_body = '<EntityInformation PartyType="Individual"> 
                        <Individual> 
                                <Name> 
                                        ...
                                        <Name TypeCode="GivenName">'.$id.'</Name>
                                </Name> 
                        </Individual> 
                </EntityInformation> 
    ...
    public function update(){
        ...
        <EntityInformation PartyType="Individual"> 
               <Individual> 
                  <ContactInformation>
                       <EMail TypeCode="Home">
                           <EMailAddress>cobacoba2@imb.com</EMailAddress>
                       </EMail>
                   </ContactInformation> 
        </Individual>
        </EntityInformation> 
...
';
        //34999 ecom business unit
        //BSONL another business unit
...
';
    ...
    public function statement(){
        ...
        $id = $_GET['id'];
        $begindate = date('Y-m-d', mktime(0, 0, 0, date("m") , date("d"), date("Y")-1));
...
<CustomerStatement xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" MajorVersion="1" xmlns="http://www.nrf-arts.org/IXRetail/namespace/">
  ...
  <CustomerBody>
    ...
    <MaximumTransaction>200</MaximumTransaction>
 	   <FromDate>'.$begindate.'</FromDate>
