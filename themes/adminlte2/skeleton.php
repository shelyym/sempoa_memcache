...
<!-- Logo -->
<a href="<?=_SPPATH;?>PushHome/home" class="logo">
    <!-- mini logo for sidebar mini 50x50 pixels -->
    <span class="logo-mini">Master Admin</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg">MA</span>
</a>
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2015 PT. Sentosa Makmur Niaga</strong> All rights
    reserved.
</footer>
